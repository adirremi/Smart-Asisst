          ...
          <div className="order-2 lg:order-1">
            <div className="mx-auto max-w-sm overflow-hidden rounded-[2rem] border-4 border-slate-900 bg-slate-900 shadow-2xl">
              ...
              >
                ...
                <Bubble from="user" time="20:44">
                  תעביר את הפגישה עם דנה לשבע בערב
                </Bubble>
                <Bubble from="bot" time="20:44">
                  {'עודכן! ✏️\n"פגישה עם דנה במשרד"\nעכשיו מחר בשעה 19:00'}
                </Bubble>
                <Bubble from="user" time="20:45">
                  תוסיף את יוסי לפגישה עם דנה
                </Bubble>
                <Bubble from="bot" time="20:45">
                  {'להוסיף את יוסי לאירוע "פגישה עם דנה" ולשלוח לו הזמנה ליומן?\nהשב "כן" לאישור.'}
                </Bubble>
                <Bubble from="user" time="20:45">
                  כן
                </Bubble>
                <Bubble from="bot" time="20:45">
                  {'בוצע! עדכנתי את האירוע ✏️\n👥 הוזמנו: יוסי'}
                </Bubble>
                <Bubble from="user" time="20:46">
                  בטל את הפגישה עם דנה
                </Bubble>
                <Bubble from="bot" time="20:46">
                  {'בטוח שברצונך לבטל את האירוע?\n"פגישה עם דנה" (מחר 19:00)\nהשב "כן" לאישור או "לא" לביטול.'}
                </Bubble>
              </div>
            </div>
          </div>
          ...
          <div className="order-1 text-center lg:order-2 lg:text-right">
            ...
            <ul className="mt-6 space-y-3 text-right">
              {[
                ...
                'ביטול ושינוי מועד — "בטל את התור", "תעביר לשבע"',
                'הוספת חבר לאירוע עם הזמנה אמיתית ליומן',
